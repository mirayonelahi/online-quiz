  ...
  (props: { subjectStore: typeof SubjectStore.Type }) => {
    return (
      <form className="w-50 subjectSettingsForm flex flex-column">
        {props.subjectStore.tempSubjects.map(
          (tempSubject: any, index: number) => (
            <div key={index}>
                  ...
                  >
                    <InputGroup
                        ...
                        <Button
                          ...
                          onClick={(e: any) => {
                            if (index > 0) {
                              ...
                              console.log(
                                props.subjectStore.tempSubjects.length
                              );
                            }
                          }}
                        />
                      ...
                      onChange={(e: any) => {
                        ...
                        if (
                          props.subjectStore.tempSubjects[
                            props.subjectStore.tempSubjects.length - 1
                          ].title !== ''
                        ) {
